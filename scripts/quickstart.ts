...
function printServiceDirectory() {
  ...
  console.log('      • \x1b[90mFeatures:\x1b[0m 2D Grid / 3D Three.js Spatial Floor Map, Tap-to-Pay, Scan-to-Pay\n');
  ...
  console.log('      • \x1b[90mFeatures:\x1b[0m Inventory Par Levels, 1-Click Purchase Orders, Menu 86ing, Staff Directory\n');

  console.log('  \x1b[1m\x1b[33m[4] Online Ordering\x1b[0m    ➜ \x1b[4m\x1b[36mhttp://localhost:5176\x1b[0m');
  console.log('      • \x1b[90mFeatures:\x1b[0m FDA Top 9 Allergen Badges, Dietary Filters (Vegan/GF), Customer Cart\n');

  console.log('  \x1b[1m\x1b[33m[5] Unified Hono API\x1b[0m   ➜ \x1b[4m\x1b[36mhttp://localhost:3000\x1b[0m');
