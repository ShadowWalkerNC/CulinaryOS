  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#0a0a0a' }}>
      <View style={{ padding: 16 }}>
        <Text style={{ color: '#ffffff', fontSize: 20, fontWeight: '700', marginBottom: 16 }}>Inventory</Text>
        <View style={{ backgroundColor: '#111111', borderRadius: 12, padding: 32, alignItems: 'center' }}>
          <Text style={{ color: '#444444', fontSize: 14 }}>Stock levels will appear here</Text>
