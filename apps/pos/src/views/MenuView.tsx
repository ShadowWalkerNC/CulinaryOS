                ...
                >
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-slate-200 mt-2.5">
                    ...
                    <Button
                      ...
                      variant="ghost"
                      onClick={() => openModifierModal(item)}
                      className="text-xs font-black text-slate-800 bg-slate-100 hover:bg-slate-900 hover:text-white border border-slate-300 hover:border-slate-900 px-3.5 py-1.5 rounded-full flex items-center gap-1.5 shadow-2xs active:scale-95"
                    >
