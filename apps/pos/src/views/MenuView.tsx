          ...
          {sections.map((s: any) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left px-3.5 py-3 rounded-xl font-bold text-xs tracking-wide transition-all flex items-center gap-3 border-2 ${
                  isActive
            ...
            {[1, 2, 3, 4].map((sNum) => {
              ...
              return (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-xs font-black transition-all flex items-center gap-1.5 shrink-0 border-2 ${
                    isSelected
                    ...
                    <div className="mt-2.5 pt-2 border-t border-dashed border-slate-200 flex flex-wrap gap-1">
                      {quickModifiers.map((qm: any) => (
                        <button
                          ...
                          className="text-[10px] font-black px-2.5 py-1 rounded-full bg-slate-100 hover:bg-slate-900 hover:text-white text-slate-700 border border-slate-200 transition-all active:scale-95 flex items-center gap-1"
