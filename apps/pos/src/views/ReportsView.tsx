      ...
      {hasOpenChecks && (
        <div className="bg-amber-500 text-slate-950 p-4 rounded-2xl shadow-lg border-2 border-amber-400 flex flex-wrap items-center justify-between gap-4 animate-fadeIn">
          ...
          <Button
            ...
            className="px-4 py-2.5 rounded-xl font-black text-xs uppercase tracking-wider shadow-md"
          >
        ...
        <div className="flex items-center gap-3">
          ...
          {zReport?.status !== 'closed' ? (
            <Button
              ...
              className={`font-black px-4 py-2.5 rounded-xl text-xs uppercase tracking-wider gap-1.5 shadow-md ${
                hasOpenChecks
